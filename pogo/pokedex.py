...
class Pokedex(ConstReflect):
    ...
    _food = [
        ZUBAT, PIDGEY, RATTATA, SPEAROW, KRABBY, WEEDLE, CATERPIE, GOLDEEN
    ]

    _trash = [
        GOLBAT, PIDGEOTTO, RATICATE, FEAROW, KINGLER, KAKUNA, METAPOD, SEAKING
    ]

    _precious = [
        ZAPDOS, MOLTRES, MEWTWO, ARTICUNO, MEW,
        DITTO, VENUSAUR, TAUROS, DRAGONITE, CLEFABLE,
        CHARIZARD, BLASTOISE, WIGGLYTUFF, DEWGONG, WEEZING,
        WEEPINBELL, WARTORTLE, VILEPLUME, VICTREEBEL,
        VENOMOTH, VAPOREON, FLAREON, JOLTEON, SLOWBRO,
        RAICHU, POLIWRATH, OMASTAR, NIDOQUEEN, NIDOKING,
        MUK, MAROWAK, LAPRAS, KANGASKHAN, KABUTOPS,
        GYARADOS, GOLEM, GENGAR, EXEGGUTOR, DRAGONAIR,
        CHARMELEON, KADABRA, ALAKAZAM, MAGMAR, NINETALES,
        RAPIDASH, CLOYSTER, HITMONLEE, HITMONCHAN, CHANSEY,
        LICKITUNG, PORYGON, HYPNO, PIKACHU, IVYSAUR
    ]
